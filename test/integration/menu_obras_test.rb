...
feature 'Menu de obras' do
  ...
  scenario 'Las facturas de pago se filtran por obra' do
    ...
    page.must_have_link @obra.nombre, href: pagos_obra_facturas_path(@obra)
  end
  ...
  scenario 'Los recibos de pago se filtran por obra' do
    ...
    page.must_have_link @obra.nombre, href: pagos_obra_recibos_path(@obra)
  end
  ...
  scenario 'Las facturas de cobro se filtran por obra' do
    ...
    page.must_have_link @obra.nombre, href: cobros_obra_facturas_path(@obra)
  end
  ...
  scenario 'Los recibos de cobro se filtran por obra' do
    ...
    page.must_have_link @obra.nombre, href: cobros_obra_recibos_path(@obra)
  end
  ...
  scenario 'Las obras se filtran por obra (?)' do
    ...
    page.must_have_link @obra.nombre, href: obra_path(@obra)
  end
  ...
  scenario 'Los índices no se filtran por obra' do
    ...
    page.must_have_link @obra.nombre, href: indices_path
  end
  ...
  scenario 'Los terceros no se filtran por obra' do
    ...
    page.must_have_link @obra.nombre, href: terceros_path
  end
end
